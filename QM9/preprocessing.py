...
def get_smiles_encodings_for_dataset(file_path):
    """
    Returns encoding, alphabet, length of largest molecule in SMILES

    Args:
        file_path (str): Path to the CSV file with molecules. Column's name must be 'smiles'.

    Returns:
        smiles_list (np.ndarray): Array of SMILES strings.
        smiles_alphabet (list): List of unique characters in the SMILES strings, plus a padding character.
        largest_smiles_len (int): Length of the longest SMILES string in the dataset.
    """
